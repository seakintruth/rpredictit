...
source(file.path(project.dir,"01_getClosedMarketData.R"))
source(file.path(project.dir,"02_readMarketDataFromDb.R"))
source(file.path(project.dir,"03_analyzeClosedMarkets.R"))
